        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-4 text-gray-600">
              Fundada em 2010, nossa empresa tem se dedicado a fornecer soluções
              inovadoras para clientes em todo o país. Com uma equipe de
              profissionais experientes, estamos comprometidos com a excelência
              e a satisfação do cliente.
            </p>
            <p className="mb-6 text-gray-600">
              Nossa missão é simplificar processos complexos e ajudar empresas a
              alcançarem seu potencial máximo através de tecnologia de ponta e
